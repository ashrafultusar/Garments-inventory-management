...
//   const [tempExtraInput, setTempExtraInput] = useState("");
...
//   // extra input add or edit
//   const handleExtraEditStart = (row) => {
//     setEditingExtraRow(row.rollNo);
//     setTempExtraInput(row.extraInputs?.join(", ") || "");
//   };

//   const handleExtraSave = (rowRollNo) => {
//     const values = tempExtraInput
//       .split(",")
//       .map((v) => v.trim())
//       .filter(Boolean);

//     const updatedRows = embeddedBatch.rows.map((row) =>
//       row.rollNo === rowRollNo ? { ...row, extraInputs: values } : row
//     );
...
//                           <input
//                             type="text"
//                             value={tempExtraInput}
//                             onChange={(e) => setTempExtraInput(e.target.value)}
//                             placeholder="10, 12, 15"
//                             className="border rounded px-2 py-1 w-32 text-sm"
//                           />
//                           <button
//                             onClick={() => handleExtraSave(row.rollNo)}
...
//                           </div>
//                           <button
//                             onClick={() => handleExtraEditStart(row)}
