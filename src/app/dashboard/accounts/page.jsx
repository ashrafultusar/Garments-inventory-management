        ...
        <>
          ...
          <form onSubmit={handleSubmit} className="border p-4 rounded-lg bg-gray-50 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2 flex gap-2">
              <button type="submit" className={`flex-1 text-white py-2 rounded transition cursor-pointer ${form.id ? 'bg-orange-600' : 'bg-green-500'}`}>
                ...
                {payments?.map((p) => (
                  <tr key={p._id} className="hover:bg-gray-50">
                    ...
                    <td className="border p-2 text-center space-x-3">
                      <button onClick={() => handleEdit(p)} className="text-blue-600 hover:text-blue-800 font-semibold cursor-pointer"><FaEdit /></button>
                      <button onClick={() => handleDelete(p._id)} className="text-red-600 hover:text-red-800 font-semibold cursor-pointer"><MdDeleteForever /></button>
                    </td>
                  </tr>
                ))}
              </tbody>
